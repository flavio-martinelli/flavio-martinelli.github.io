...
- *Identifiability*: can network parameters be reverse engineered? What constraints are needed? What are the implications for neural circuits?
- *Trainability*: what weight structures are easier or harder to learn? What are the weight structures of sub-optimal solutions (local minima)?
